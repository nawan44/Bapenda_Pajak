...
var multiIndexSearch = function multiIndexSearch(indexName, client, helper, sharedParameters, _ref) {
  ...
  var searches = [helper.searchOnce(_objectSpread(_objectSpread({}, sharedParameters), mainParameters))].concat((0, _toConsumableArray2.default)(indexIds.map(function (indexId) {
...
var findResultsState = function findResultsState(App, props) {
  ...
  function execute(props) {
    ...
    return multiIndexSearch(props.indexName, props.searchClient, helper, sharedParameters, derivedParameters).then(function (results) {
      return {
        metadata: metadata,
        results: results
      };
