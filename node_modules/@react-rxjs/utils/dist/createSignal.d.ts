 ...
 */
export declare function createSignal<A extends unknown[], T>(mapper: (...args: A) => T): [Observable<T>, (...args: A) => void];
/**
 ...
 * 2. The emitter function.
 */
export declare function createSignal(): [Observable<void>, () => void];
/**
 * Creates a signal. It's sugar for splitting the Observer and the Observable of a signal.
 *
 * @returns [1, 2]
 ...
 * 2. The emitter function.
 */
export declare function createSignal<T>(): [Observable<T>, (payload: T) => void];
