 ...
 * for the first value.
 */
export default function connectObservable<T>(observable: Observable<T>, defaultValue: T): readonly [() => Exclude<T, typeof import("..").SUSPENSE>, import("../internal/BehaviorObservable").BehaviorObservable<T>];
