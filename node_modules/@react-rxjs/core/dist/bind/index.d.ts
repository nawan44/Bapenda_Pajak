 ...
 * for the first value.
 */
export declare function bind<T>(observable: Observable<T>, defaultValue?: T): [() => Exclude<T, typeof SUSPENSE>, Observable<T>];
/**
 ...
 * for the first value.
 */
export declare function bind<A extends unknown[], O>(getObservable: (...args: A) => Observable<O>, defaultValue?: O | ((...args: A) => O)): [(...args: A) => Exclude<O, typeof SUSPENSE>, (...args: A) => Observable<O>];
