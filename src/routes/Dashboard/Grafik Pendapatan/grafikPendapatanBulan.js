    ...
    <Widget
      ...
      title={
        ...
        <div style={{width:"25%", float:"left"}}>
          {" "}
          <Typography style={{margin:"20px 0", fontSize:"14px", fontWeight:"bold"}}>Jenis Grafik</Typography>
        </div>
        <div span={8} style={{width:"70%", float:"left"}}>
          {" "}
          <Select
            style={{ margin: "10px 0 0 0", width: "50%" }}
            name="jenisChart"
            value={jenisChart}
