...
class AddContact extends React.Component {
  constructor(props) {
    ...
    const {id, thumb, name, username, phone, designation, selected, starred, frequently} = props.contact;
    this.state = {
      id,
      thumb,
      name,
  ...
  render() {
    ...
    const {id, name, username, phone, designation, selected, starred, frequently} = this.state;
