...
const Productivity = ({ selectedRecord, setSelectedRecord, listData, setListData, aksiList, itemList }) => {
 console.log(itemList)
  return (
    <Widget styleName={`gx-card-full gx-bg-${itemList.status}`} extra={<i className="icon icon-setting gx-text-grey gx-fs-xl"/>}>
      ...
      <div className="gx-rechart">
        <div className="gx-rechart-prod">
          ...
          <p className="gx-text-left gx-text-dark">Productivity</p>
        </div>
